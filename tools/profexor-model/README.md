...
- `profexor-wordmark-v2.glb`: face-weighted, densely remeshed particle/effect geometry.
- `profexor-wordmark-hitbox-v2.glb`: lower-density mouse raycast geometry.
...
reachable JavaScript module graph, rooted at `app-profexor-v2.js`, and updates
